...
public class QatarAirlines extends Flight implements Airline {
    public QatarAirlines(String flightId, String routeId, String arrivalTime, String departureTime, double flightFare,
