...
double newtonForwardInterpolation(const vector<double>& x, const vector<double>& y, double xValue) {
    int n = x.size();
...
int main() {
    ...
    double interpolatedValue = newtonForwardInterpolation(x, y, xValue);
